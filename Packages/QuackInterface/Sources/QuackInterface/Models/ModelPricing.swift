...
public struct ModelPricing: Sendable {
    ...
    public func cost(inputTokens: Int, outputTokens: Int, reasoningTokens: Int = 0) -> Double {
...
public final class ModelPricingService {
    ...
    public var isLoaded: Bool { lastFetched != nil }
...
struct ModelsDevProvider: Decodable, Sendable {
    let id: String
    let name: String
...
struct ModelsDevModel: Decodable, Sendable {
    let id: String
    let name: String
...
struct ModelsDevCost: Decodable, Sendable {
    let input: Double
    let output: Double
...
extension ProviderPlatform {
    ...
    public var modelsDevProviderIDs: [String] {
        switch self {
