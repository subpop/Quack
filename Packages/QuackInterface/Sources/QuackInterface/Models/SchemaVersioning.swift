...
// MARK: - Schema V5 (Agent Skills & Working Directory)

/// V5 introduces the `AgentSkill` model for installed skills, adds
/// `alwaysEnabledSkillNamesRaw` to `ChatSession` and `Assistant`,
/// and `workingDirectory` to `ChatSession`.
...
// MARK: - Schema V6 (Session Summary)

/// V6 adds `summary` to `ChatSession` for auto-generated session topic summaries.
...
// MARK: - Schema V7 (Attachments)

public enum QuackSchemaV7: VersionedSchema {
    public nonisolated(unsafe) static var versionIdentifier: Schema.Version = .init(7, 0, 0)
...
// MARK: - Schema V8 (Context Window Management)

/// V8 adds `isCompactionSummary` and `compactedMessageCount` to
/// `ChatMessageRecord` for context compaction.
public enum QuackSchemaV8: VersionedSchema {
    public nonisolated(unsafe) static var versionIdentifier: Schema.Version = .init(8, 0, 0)
...
public enum QuackMigrationPlan: SchemaMigrationPlan {
    public static var schemas: [any VersionedSchema.Type] {
        [QuackSchemaV1.self, QuackSchemaV2.self, QuackSchemaV3.self, QuackSchemaV4.self, QuackSchemaV5.self, QuackSchemaV6.self, QuackSchemaV7.self, QuackSchemaV8.self]
    }
    ...
    public static var stages: [MigrationStage] {
        [
            ...
            // V4 → V5: adds AgentSkill model, workingDirectory to ChatSession.
            .lightweight(fromVersion: QuackSchemaV4.self, toVersion: QuackSchemaV5.self),
            // V5 → V6: adds summary to ChatSession.
            .lightweight(fromVersion: QuackSchemaV5.self, toVersion: QuackSchemaV6.self),
            // V6 → V7: adds attachmentsJSON to ChatMessageRecord.
            .lightweight(fromVersion: QuackSchemaV6.self, toVersion: QuackSchemaV7.self),
            // V7 → V8: adds compaction fields to ChatMessageRecord.
            .lightweight(fromVersion: QuackSchemaV7.self, toVersion: QuackSchemaV8.self),
        ]
    }
}
