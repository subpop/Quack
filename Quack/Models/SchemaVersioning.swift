...
enum QuackSchemaV3: VersionedSchema {
    nonisolated(unsafe) static var versionIdentifier: Schema.Version = .init(3, 0, 0)
...
enum QuackSchemaV4: VersionedSchema {
    nonisolated(unsafe) static var versionIdentifier: Schema.Version = .init(4, 0, 0)
...
enum QuackMigrationPlan: SchemaMigrationPlan {
    static var schemas: [any VersionedSchema.Type] {
        [QuackSchemaV1.self, QuackSchemaV2.self, QuackSchemaV3.self, QuackSchemaV4.self]
    }
