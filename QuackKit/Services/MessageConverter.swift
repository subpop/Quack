...
public enum MessageConverter {
    ...
    public static func toChatMessages(_ records: [ChatMessageRecord]) -> [ChatMessage] {
    ...
    public static func toRecord(from assistant: AssistantMessage) -> ChatMessageRecord {
