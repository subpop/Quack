...
@Observable
@MainActor
public final class ModelListService: ModelListServiceProtocol {
    // MARK: - Cache Entry
    ...
    public func isLoading(for profile: ProviderProfile) -> Bool {
    ...
    public func models(for profile: ProviderProfile) -> [String] {
    ...
    public func fetchModels(for profile: ProviderProfile) async {
    ...
    public func invalidate(for profile: ProviderProfile) {
